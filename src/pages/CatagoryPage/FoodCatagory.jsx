...
export default function FoodCatagory() {
  ...
  useEffect(() => {
    const getMax = async() => {
      try{
        const res = await axios.get("/api/category/max/2")
  ...
  return (
    <div className='catagoryHome-container'>
      ...
      <div className='right'>
        ...
        <div className='banner'><p><b>FOOD</b></p></div>
...

            {
              itemData.map((data, key) => {
                if(verify){
                  ...
                  if(radioValue === "ending_soon" && data.seller_verification === 1) {
                    return (
                      <div className="card-frame" key={key}>
                        <div className="img1">
                          <img src={`api/img/item/${data.image}`} alt="itemImage" />
                  ...
                  if(radioValue === "ending_soon" && data.more <= 5 && data.more > 0) {
                    return (
                      <div className="card-frame" key={key}>
                        <div className="img1">
                          <img src={`api/img/item/${data.image}`} alt="itemImage" />
